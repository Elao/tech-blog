...
**Avertissement :**
Depuis la rédaction de cet article sur l'injection de dépendances, le coeur de Symfony2 a évolué de façon notable, en particulier certaines classes du répertoire **DependencyInjection** mentionnées dans cet article ont été renommées, révisées, ou refondues. Toutefois, les principes généraux décrits dans cet article restent d'actualité.Le 21 décembre 201

<img title="dependency-injection-symfony" src="/blog/medias/2010-06-03-symfony-2-linjection-de-dependances/dependency-injection-symfony.png" alt="dependency injection symfony Symfony 2   Linjection de dépendances" width="278" height="236" />
...
<img title="di-folder" src="/blog/medias/2010-06-03-symfony-2-linjection-de-dependances/di-folder.png" alt="di folder Symfony 2   Linjection de dépendances" width="284" height="253" />
...
<img title="injection-dependances" src="/blog/medias/2010-06-03-symfony-2-linjection-de-dependances/injection-dependances.png" alt="injection dependances Symfony 2   Linjection de dépendances" width="846" height="468" />
...
#### L
 **</span>Comme vous pouvez le constater, une méthode getLoggerService est générée. Cette méthode est générée car un alias a été défini lors de la configuration du builder (ligne 59 du fichier ZendExtension.php).
